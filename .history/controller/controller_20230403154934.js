...
document.querySelector("#btnCapNhat").addEventListener("click", function () {
  ...
  nhanVien[indexEdit].email = nhanVienEdit.ngayLam;
  nhanVien[indexEdit].email = nhanVienEdit.password;
  nhanVien[indexEdit].email = nhanVienEdit.luong;
  nhanVien[indexEdit].email = nhanVienEdit.gioLam;
  nhanVien[indexEdit].email = nhanVienEdit.heSoLuong;
});
...
document.querySelector("#btnLayNV").addEventListener("click", function () {
  nhanVien.forEach((nhanvien, index) => {
    if (document.querySelector("#tknv").value === nhanvien.taiKhoan) {
      ...
      document.querySelector("#chucvu").value = nhanVien[index].chucVu;
