...
addNhanVien = () => {
  ...
  valid =
    ...
    required(addNV.password, "password", "error-luong") &
    required(addNV.password, "password", "error-giolam");

  // Check email
  valid = checkEmail(addNV.email, "email", "error-email");


  // Check lương
  valid = checkLuong(addNV.luong, "luongCB", "error-luong");


  // Check lương vào giờ làm
  valid = checkGioLam(addNV.gioLam, "gioLam", "error-giolam");
