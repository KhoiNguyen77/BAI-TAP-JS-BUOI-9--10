...
// Thêm function vào trong nút cập nhật
document.querySelector("#btnCapNhat").setAttribute("onclick", "updateNhanVien('${nhanVien.taiKhoan')");


// cập nhật nhân viên;
document.querySelector("#btnCapNhat").addEventListener("click", updateNhanVien);
